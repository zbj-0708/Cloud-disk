...
//////////////////////INI配置文件/////////////////////
#define INI_PATH  "./Cloud.ini"
#define INI_MAX_PATH_SIZE  30
#define INI_NUMBER_SIZE     10
#define INI_PASSWORD_SIZE   20
#define VIDEO_STREAM  "rtmp://192.168.113.170:1935/vod//"
...
#define BLOCK_SIZE (4096*1024*20)
...
typedef struct STRU_BIG_FILE_DATABLOCK
{
    ...
    {
        block_size = sizeof( STRU_BIG_FILE_DATABLOCK )-4;
